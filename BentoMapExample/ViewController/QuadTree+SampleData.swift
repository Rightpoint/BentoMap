...
extension QuadTree {
    ...
    static var sampleData: QuadTree<Int> {
        var samples = QuadTree<Int>(BentoBox: BentoBox(minCoordinate: CLLocationCoordinate2D.minCoord, maxCoordinate: CLLocationCoordinate2D.maxCoord), bucketCapacity: 5)
        for count in 1...5000 {
